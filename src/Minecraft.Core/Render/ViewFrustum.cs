...
public sealed class ViewFrustum
{
    ...
    public void UpdateFrustumPoints(Camera camera)
    {
        ...
        _frustumPlanes[2].normal = normal;
        ...
        _frustumPlanes[3].normal = normal;
        ...
        _frustumPlanes[4].normal = normal;
        ...
        _frustumPlanes[5].normal = normal;
