...
public static class FloodFillLight
{
    ...
    /// </summary>
    private readonly struct LightAddNode
    {
    ...
    /// </summary>
    private readonly struct LightRemoveNode
    {
        public readonly Chunk Chunk;
        public readonly Vector3i ChunkLocalPos;
    ...
    {
        return RepairSunlightGridOnBlockAdded(world, chunk, blockPos).Where(c => c != chunk).ToArray();
    }
